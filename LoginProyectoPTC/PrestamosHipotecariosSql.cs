...
namespace SBPA
{
    internal class PrestamosHipotecariosSql
    {
        ...
        public PrestamosHipotecariosSql(string iUsuario, string iDUI, string iContrasena, int iNumeroOperacion, string iFechaRegistro, string iNombre_cliente,
        ...
        public PrestamosHipotecariosSql()
        {
        ...
        public bool Agregar()
        {
            string comando = "insert into prestamos_hipotecarios (Usuario, DUI, Contrasena, NumeroOperacion, FechaRegistro, Nombre_cliente, TipoDocumento, " +
        ...
        {
            string comando = "DELETE FROM prestamos_hipotecarios WHERE " +
                "Usuario = '" + Usuario + "';";
        ...
        public bool Actualizar()
        {
                        ...
                        string comando = "update prestamos_hipotecarios set Usuario= '" +
